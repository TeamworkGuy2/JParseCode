...
public class GenericTypeParser {
	 ...
	 */
	public static CharParser createGenericTypeStatementCondition(int genericTypeDepth, Supplier<CharParser> singleIdentifierParserConstructor) {
		return _createGenericTypeStatementCondition(genericTypeDepth, singleIdentifierParserConstructor);
	}


	public static CharParser _createGenericTypeStatementCondition(int recursionDepth, Supplier<CharParser> singleIdentifierParserConstructor) {
