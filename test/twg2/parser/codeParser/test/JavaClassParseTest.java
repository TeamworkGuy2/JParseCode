...
public class JavaClassParseTest {
	...
	@Parameter
	private CodeFileSrc file = ParseCodeFile.parseFiles(Arrays.asList(Paths.get("rsc/java/ParserExamples/Models/TrackInfo.java")), FileReadUtil.threadLocalInst(), null).get(0);
