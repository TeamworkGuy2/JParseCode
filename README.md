...
* A 'code first' parser aimed at manipulating the resulting AST and writing it back as source code.  With the goal of allow simple language constructs like interfaces to be transpiled to different languages. 
